...
CFLAGS='-O -fPIC' ./configure --prefix=$HOME/opt --enable-cflags="-I$HOME/opt/include" --enable-cppflags="-I$HOME/opt/include" --enable-ldflags="-L$HOME/opt/lib" --enable-multibyte --enable-locale --with-tcsetpgrp
make
make install
