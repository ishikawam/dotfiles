...
macos-manual-settings: ## macOSの手動設定をガイド
	...
	@echo ""
	@echo "----------------------------------------"
	@echo "■ Privacy & Security > Privacy > Location Services"
	@echo "----------------------------------------"
	@echo "  - Siri = オフ"
	@echo "  - Chrome, Reminders, Voice Memos = オン"
	@echo "  - System Services > Details > Show location icon... = オン"
	@echo ""
	...
	@echo ""
	@echo "----------------------------------------"
	@echo "■ Privacy & Security > Security"
	@echo "----------------------------------------"
	@echo "  - Allow accessories to connect = Always"
	@echo ""
	...
	@echo "----------------------------------------"
	@echo "  - Google個人 = Contacts & Calendars"
	@echo "  - Google会社 = Calendars"
	@echo ""
